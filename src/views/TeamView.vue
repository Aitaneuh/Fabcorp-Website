...
<template>
    <div class="team-page">
        <header class="team-header">
            ...
            <p>
                Two developers, one vision. We combined our obsession for clean code
                to build a studio that prioritizes quality over quantity.
            </p>
        </header>

        <!-- Team List -->
        <section class="team-list">
            <TeamMember name="Lead Developer One" role="System Architect"
            ...
            <TeamMember name="Lead Developer Two" role="Frontend Specialist"
